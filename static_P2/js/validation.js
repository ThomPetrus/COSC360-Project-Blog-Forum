...
function validatePW(pw) {
    ...
    var box = document.getElementById("inputPassword");
...
function validateConfirmPW(pw) {
    var button = document.getElementById("sign-in-button");
    var box = document.getElementById("inputConfirmPassword");
    var firstPW = document.getElementById("inputPassword").value;
    var header = document.getElementById("main-header");
...
function validateEmail(email) {
    var box = document.getElementById("inputEmail");
